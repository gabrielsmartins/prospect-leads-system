...
@AnalyzeClasses(packages = "br.pucminas.quotes.application", importOptions = {ImportOption.DoNotIncludeTests.class})
public class DomainClassRuleTest {

    @ArchTest
    public static ArchRule portInRule = classes()
                                        .that()
                                        .resideInAPackage("br.pucminas.quotes.application.ports.in..")
                                        .should()
    ...
    public static ArchRule portOutRule = classes()
                                            .that()
                                            .resideInAPackage("br.pucminas.quotes.application.ports.out..")
                                            .should()
    ...
    public static ArchRule serviceRule = classes()
                                            .that()
                                            .resideInAPackage("br.pucminas.quotes.application.service..")
                                            .and()
