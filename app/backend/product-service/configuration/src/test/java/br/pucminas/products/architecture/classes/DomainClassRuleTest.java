...
@AnalyzeClasses(packages = "br.pucminas.products.application", importOptions = {ImportOption.DoNotIncludeTests.class})
public class DomainClassRuleTest {

    @ArchTest
    public static ArchRule portInRule = classes()
                                        .that()
                                        .resideInAPackage("br.pucminas.products.application.ports.in..")
                                        .should()
    ...
    public static ArchRule portOutRule = classes()
                                            .that()
                                            .resideInAPackage("br.pucminas.products.application.ports.out..")
                                            .should()
    ...
    public static ArchRule serviceRule = classes()
                                            .that()
                                            .resideInAPackage("br.pucminas.products.application.service..")
                                            .and()
