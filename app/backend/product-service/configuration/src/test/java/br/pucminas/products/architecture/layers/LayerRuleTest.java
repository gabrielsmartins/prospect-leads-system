package br.pucminas.products.architecture.layers;
...
@AnalyzeClasses(packages = "br.pucminas.products", importOptions = {ImportOption.DoNotIncludeTests.class})
public class LayerRuleTest {

    private static final String APPLICATION_PACKAGE = "br.pucminas.products.application..";
    private static final String WEB_PACKAGE = "br.pucminas.products.adapters.web..";
    private static final String PERSISTENCE_PACKAGE = "br.pucminas.products.adapters.persistence..";
    private static final String CONFIGURATION_PACKAGE = "br.pucminas.products";
