...
import br.pucminas.leads.adapters.streams.config.TopicProperties;
...
class SendLeadStreamAdapterTest {
    ...
    private final SendLeadStreamAdapter adapter;
    ...
    private Consumer<String, SpecificRecord> createConsumer() {
        Map<String, Object> consumerProps = KafkaTestUtils.consumerProps(SendLeadStreamAdapterTest.class.getSimpleName(), "true", embeddedKafkaBroker);
