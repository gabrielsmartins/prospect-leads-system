...
@AnalyzeClasses(packages = "br.pucminas.bff.application", importOptions = {ImportOption.DoNotIncludeTests.class})
public class DomainClassRuleTest {

    @ArchTest
    public static ArchRule portInRule = classes()
                                        .that()
                                        .resideInAPackage("br.pucminas.bff.application.ports.in..")
                                        .should()
    ...
    public static ArchRule portOutRule = classes()
                                            .that()
                                            .resideInAPackage("br.pucminas.bff.application.ports.out..")
                                            .should()
    ...
    public static ArchRule serviceRule = classes()
                                            .that()
                                            .resideInAPackage("br.pucminas.bff.application.service..")
                                            .and()
